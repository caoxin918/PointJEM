...
class ModelNet40(Dataset):
    def __init__(self,trans, num_points, partition='train', normalize=False):
        self.trans = trans
    ...
    def __getitem__(self, item):
        ...
        if self.partition == 'train':
            data1 = torch.tensor(copy.deepcopy(pointcloud))
            data2 = torch.tensor(copy.deepcopy(pointcloud))
            data1 = self.trans(data1)
            data2 = self.trans(data2)
        return data1, data2
